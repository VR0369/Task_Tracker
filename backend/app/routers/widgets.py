...
from ..models.misc import HistoryEvent, Quote, WeatherResponse
...
async def weather(
    ...
    loc = location or (user.get("settings") or {}).get("weather_location") or "New York"
    return WeatherResponse(**await weather_service.get_weather(loc))
